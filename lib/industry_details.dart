...
class IndustryDetailsPage extends StatelessWidget {
                ...
                _buildOptionCard(
                  ...
                  "assets/images/swp.jpg",
                     () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => IndustryWasteSelection()),
                        );
                  },
                ),
                SizedBox(width: 20),
                _buildOptionCard(
                  ...
                  "assets/images/rwr.PNG",
                      () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => WasteDetailsPage()),
                        );
                  },
                ),
              ],
  ...
  Widget _buildOptionCard(BuildContext context, String text, String imagePath, VoidCallback onPressed) {
    return Expanded(
      child: Column(
        children: [
          Container(
